...
با انتخاب گزینه‌ی "عدم نمایش"، آن مورد نمایش داده نمی‌شود.
		...
		array(
			'key' => 'field_5dd0dc9e3e768',
			'label' => 'عدم نمایش بخش‌های "مخاطبین دوره"',
			'name' => '',
			'type' => 'message',
			'instructions' => '',
			'required' => 0,
...
با انتخاب گزینه‌ی "عدم نمایش"، آن مورد نمایش داده نمی‌شود.
		...
		array(
			'key' => 'field_5dd0debdf0051',
			'label' => 'اعمال تنظیمات برای "عدم نمایش بخش‌های مخاطبین دوره"',
			'name' => 'show-set-settings2',
			'type' => 'true_false',
			'instructions' => 'برای اعمال تنظیمات روی این بخش، این گزینه را تیک بزنید.',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5dd0dcf33e769',
			'label' => 'عدم نمایش کلی باکس "مخاطبین دوره"',
			'name' => 'remove-course-requirement',
			'type' => 'true_false',
			'instructions' => 'با انتخاب این گزینه، عنوان و تمامی محتویات این باکس، نمایش داده نمی‌شود.',
			'required' => 0,
			'conditional_logic' => array(
		...
		array(
			'key' => 'field_5dd0dcfb3e76a',
			'label' => 'عدم نمایش عنوان "مخاطبین دوره"',
			'name' => 'remove-course-requirement-title',
			'type' => 'true_false',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => array(
		...
		array(
			'key' => 'field_5dd0dd063e76b',
			'label' => 'عدم نمایش توضیح کوتاه در "مخاطبین دوره"',
			'name' => 'remove-course-requirement-littledetail',
			'type' => 'true_false',
			'instructions' => 'با انتخاب این بخش، توضیح کوتاه
<br>"*عنوان دوره* دارای پیش نیازهایی می باشد که قبل از ثبت نام می بایست به آنها توجه کنید تا در ادامه آموزش به مشکل نخورید."
<br>حذف می‌شود.',
			'required' => 0,
			'conditional_logic' => array(
				array(
		...
		array(
			'key' => 'field_5dd0ddde3e76c',
			'label' => 'عدم نمایش لیست "توصیه می‌شود" در "مخاطبین دوره"',
			'name' => 'remove-course-requirement-reqbox',
			'type' => 'true_false',
			'instructions' => 'با انتخاب این بخش، لیست "این دوره برای چه کسانی توصیه می شود؟" نمایش داده نمی‌شود.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
		...
		array(
			'key' => 'field_5dd0de7a3e76d',
			'label' => 'عدم نمایش لیست "توصیه نمی‌شود" در "مخاطبین دوره"',
			'name' => 'remove-course-requirement-unreqbox',
			'type' => 'true_false',
			'instructions' => 'با انتخاب این بخش، لیست "این دوره برای چه کسانی توصیه نمی شود؟" نمایش داده نمی‌شود.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
		...
		array(
			'key' => 'field_5dd2c8495d680',
			'label' => 'عدم نمایش تصاویر سمت چپ در "مخاطبین دوره"',
			'name' => 'remove-course-requirement-imgs',
			'type' => 'true_false',
			'instructions' => 'با انتخاب این بخش، چهار تصویر سمت چپ نمایش داده نمی‌شود.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
...
با انتخاب گزینه‌ی "عدم نمایش"، آن مورد نمایش داده نمی‌شود.
		...
		array(
			'key' => 'field_5e1084ebca556',
			'label' => 'عدم نمایش کلی باکس "نرم افزار های کار شده در دوره"',
			'name' => 'remove-softwares',
			'type' => 'true_false',
			'instructions' => 'برای نمایش این باکس، روی نمایش داده شود و برای عدم نمایش، روی عدم نمایش کلیک کنید.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
...
acf_add_local_field_group(array(
	'key' => 'group_5e1059f92a19a2',
	'title' => 'نرم افزار های کار شده در دوره',
	'fields' => array(
		array(
			'key' => 'field_5e105f8f8afefe',
			'label' => 'نام نرم افزار های دوره',
			'name' => 'lessons-2',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و نام نرم افزار را اضافه کنید.<br>.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
			...
			'choices' => array(
				'نرم افزار اول' => 'نرم افزار اول',
				'نرم افزار دوم' => 'نرم افزار دوم',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
		...
		array(
			'key' => 'field_5e105f8f8afefe-d',
			'label' => 'آموزش این نرم افزار',
			'name' => 'lessons-2-learn',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و لینک آموزش را اضافه کنید.<br>.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
			...
			'choices' => array(
				'آموزش اول' => 'http://google.com',
				'آموزش دوم' => 'http://facebook.com',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
		...
		array(
			'key' => 'field_5e105f8f8afefe-dhh',
			'label' => 'این نرم افزار در ویکی پدیا',
			'name' => 'lessons-3-learn',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و لینک ویکی پدیا را اضافه کنید.<br>.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
			...
			'choices' => array(
				'لینک اول' => 'http://google.com',
				'لینک دوم' => 'http://facebook.com',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
		...
		array(
			'key' => 'field_5e105f8f8afefe-dfff',
			'label' => 'دانلود این نرم افزار',
			'name' => 'lessons-4-learn',
			'type' => 'checkbox',
		...
		array(
			'key' => 'field_5e107ec96c453d',
			'label' => 'تصاویر نرم افزار های دوره',
			'name' => 'lessonsimgs-2',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و آدرس تصویری که از مسیر "رسانه‌ها>افزودن" آپلود کردید را اضافه کنید.<br>
سایز تصویر: 80 در 80 پیکسل. نکته‌ی مهم: به ازای هر نرم افزار دوره، یک تصویر باید اضافه کنید.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
			...
			'choices' => array(
				'http://localhost:8080/hamyarlearn/wp-content/uploads/2019/11/hamyar-sq.png' => 'http://localhost:8080/hamyarlearn/wp-content/uploads/2019/11/hamyar-sq.png',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
...
acf_add_local_field_group(array(
	'key' => 'group_5e1059f92a19a2fdfscdcgrgdddd',
	'title' => 'ویدئو های نقدی',
	'fields' => array(
		array(
			'key' => 'field_5egrg105f8f8afefedfdbdsdwvrgr',
			'label' => 'نام ویدئو رو وارد کنید',
			'name' => 'video-2-name-buy',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و نام ویدئو را اضافه کنید.<br>.',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array(
			'key' => 'field_5e105f8f8afefedrgrgedefdfdefefe',
			'label' => 'توضیحات ویدئو رو وارد کنید',
			'name' => 'video-2-description-buy',
			'type' => 'checkbox',
			'instructions' => 'روی افزودن کلیک کنید و توضیحات ویدئو را اضافه کنید.<br>.',
			'required' => 0,
			'conditional_logic' => 0,
...
acf_add_local_field_group(array(
	'key' => 'group_5dd019775f91b',
	'title' => 'مخاطبین دوره',
	'fields' => array(
		array(
			'key' => 'field_5dd01bff8b925',
			'label' => 'عنوان "این دوره برای چه کسانی توصیه می شود؟"',
			'name' => 'course-requirement-reqtitle',
			'type' => 'text',
			'instructions' => 'عنوان دلخواه تان را بنویسید.',
			'required' => 1,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'default_value' => '',
			'placeholder' => 'مثلا: این دوره برای چه کسانی توصیه می شود؟',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
		array(
			'key' => 'field_5dd01986582c7',
			'label' => 'پارامترها برای شرکت در دوره',
			'name' => 'course-requirement-reqli',
			'type' => 'checkbox',
			'instructions' => 'با زدن دکمه‌ی "درج انتخاب جدید"، یک پارامتر جدید اضافه کنید و محتوای دلخواه تان را بنویسید. اگر می‌خواهید این پارامترهای پیش فرض نمایش داده نشوند، تیک آنها را حذف کنید.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
			...
			'choices' => array(
				'برای تمام کسانی که به فکر راه اندازی کسب و کار آنلاین خود هستند.' => 'برای تمام کسانی که به فکر راه اندازی کسب و کار آنلاین خود هستند.',
				'افرادی که میخواهند سایت راه اندازی کنند و میخواهند آن را کامل نمایند.' => 'افرادی که میخواهند سایت راه اندازی کنند و میخواهند آن را کامل نمایند.',
				'صاحبان کسب و کاری که به فکر ورود قدرتمند به دنیای مجازی هستند.' => 'صاحبان کسب و کاری که به فکر ورود قدرتمند به دنیای مجازی هستند.',
				'افرادی که خدمات طراحی سایت میدهند، و میخواهند سطح و قیمت پروژه های طراحی سایت خود را افزایش دهند.' => 'افرادی که خدمات طراحی سایت میدهند، و میخواهند سطح و قیمت پروژه های طراحی سایت خود را افزایش دهند.',
				'طراحی اپلیکیشن' => 'طراحی اپلیکیشن',
				'برای افرادی که علاقه دارند.' => 'برای افرادی که علاقه دارند.',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
		...
		array(
			'key' => 'field_5dd01e42a087c',
			'label' => 'عنوان "این دوره برای چه کسانی توصیه نمی شود؟"',
			'name' => 'course-requirement-unreqtitle',
			'type' => 'text',
			'instructions' => 'عنوان دلخواه تان را بنویسید.',
			'required' => 1,
			'conditional_logic' => 0,
			...
			'default_value' => '',
			'placeholder' => 'مثلا: این دوره برای چه کسانی توصیه نمی شود؟',
			'prepend' => '',
			'append' => '',
			'maxlength' => '',
		),
		array(
			'key' => 'field_5dd01e6ea087d',
			'label' => 'پارامترهایی که اگر کاربر ندارد، در دوره شرکت نکند',
			'name' => 'course-requirement-unreqli',
			'type' => 'checkbox',
			'instructions' => 'با زدن دکمه‌ی "درج انتخاب جدید"، یک پارامتر جدید اضافه کنید و محتوای دلخواه تان را بنویسید. اگر می‌خواهید این پارامترهای پیش فرض نمایش داده نشوند، تیک آنها را حذف کنید.',
			'required' => 0,
			'conditional_logic' => 0,
			...
			'choices' => array(
				'کسانی که از درآمد کنونی خود رضایت کامل دارند.' => 'کسانی که از درآمد کنونی خود رضایت کامل دارند.',
				'کسانی که هیچ اعتقادی به درآمد آنلاین ندارند.' => 'کسانی که هیچ اعتقادی به درآمد آنلاین ندارند.',
				'کسانی که علاقه دارند تا با روش های قدیمی، فعالیت نمایند.' => 'کسانی که علاقه دارند تا با روش های قدیمی، فعالیت نمایند.',
				'کسانی که احساس می‌کنند به آموزش کسب و کار اینترنتی نیازی ندارند.' => 'کسانی که احساس می‌کنند به آموزش کسب و کار اینترنتی نیازی ندارند.',
			),
			'allow_custom' => 1,
			'save_custom' => 1,
			'default_value' => array(
