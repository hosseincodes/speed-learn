...
<div class="container">
    ...
    <h1 class="cource-title"><?php the_title(); ?></h1>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 col-12 course-content">
...
$loop = new WP_Query($args); if($loop->have_posts()){ ?>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
                            <div class="thumbnail courses blog">
                                ...
                                <div class="caption">
                                    <a style="font-family: 'Aviny' !important; font-size: 22px;"
                                        href="<?php echo the_permalink(); ?>"><?php the_title() ?></a>
                                    <div class="row stars-teacher">
                                        <div class="col-md-4 col-xs-6 col-sm-6 users"><i style="margin-left: 5px;"
                                                class="fas fa-users"></i><?php global $product; $units_sold = get_post_meta( $product->id, 'total_sales', true ); echo ''. sprintf( __( '%s', 'woocommerce' ), $units_sold ).''; ?>
                                        </div>
                                        <div class="col-md-8 col-xs-6 col-sm-6 teacher">
                                            <a href="#"><i style="margin-left: 5px;"
                                                    class="fas fa-user"></i><?php the_author() ?></a>
                                        </div>
                                    </div>
                                    <hr style="color: #e9ebed; margin: 0px;">
                                    <div class="row price-student">
                                        <div class="col-md-2"></div>
                                        <div class="col-md-8 col-xs-5 col-sm-5 price-2">
    ...
    <?php } wp_reset_postdata(); ?>
        ...
        <h3 class="all-areas-title">دوره هایی از این دسته بندی</h3>
